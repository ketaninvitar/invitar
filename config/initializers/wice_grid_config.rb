if defined?(Wice::Defaults)
  ...
  Wice::Defaults::SHOW_HIDE_FILTER_ICON = '/images/page_white_find.png'


  # Icon to trigger filtering.
  Wice::Defaults::FILTER_ICON = '/images/table_refresh.png'

  # Icon to reset the filter.
  Wice::Defaults::RESET_ICON = "/images/table.png"

  # Icon to reset the filter.
  Wice::Defaults::TOGGLE_MULTI_SELECT_ICON = "/imagesexpand.png"

  # CSV Export icon.
  Wice::Defaults::CSV_EXPORT_ICON = "/images/page_white_excel.png"

  # Tick-All icon for the action column.
  Wice::Defaults::TICK_ALL_ICON = "/images/tick_all.png"

  # Untick-All icon for the action column.
  Wice::Defaults::UNTICK_ALL_ICON = "/imagesuntick_all.png"
